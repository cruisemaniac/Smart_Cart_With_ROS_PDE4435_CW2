...
second-generation prototype. The Computer Vision Upgrade directly
addresses the primary user-experience limitation of the current
design --- the requirement for the user to carry a UWB remote tag.
The Return-to-Base feature addresses the operational limitation of
requiring staff to manually collect and dock carts between sessions.
