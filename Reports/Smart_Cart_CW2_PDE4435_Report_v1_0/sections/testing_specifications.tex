...
\textbf{ID} & \textbf{Description} & \textbf{Method} & \textbf{Acceptance Criteria} \\
\midrule
T2.1 & ROS~2 topic publish rates & \texttt{ros2 topic hz} monitoring all nodes & UWB topics at $\geq$20\,Hz; control loop at $\geq$20\,Hz; nav status at $\geq$2\,Hz \\
T2.2 & Serial bridge latency & Timestamp sensor data vs.\ ROS topic & End-to-end latency $<$30\,ms \\
T2.3 & UWB + Kalman filter stability & Move person around cart perimeter 3$\times$ using \texttt{teleop\_person\_node} & No position jumps $>$20\,cm; Kalman-smoothed estimate converges after warmup \\
...
\textbf{ID} & \textbf{Description} & \textbf{Method} & \textbf{Acceptance Criteria} \\
\midrule
T3.1 & Follow-me straight line & User walks 10\,m corridor; cart follows & Cart maintains 1.0\,m $\pm$ 0.15\,m following distance \\
