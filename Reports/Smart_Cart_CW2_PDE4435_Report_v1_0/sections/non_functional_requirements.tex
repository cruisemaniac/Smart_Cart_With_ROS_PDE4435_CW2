...
UWB position update rate & 20\,Hz & Simulated UWB node publishes at 20\,Hz; hardware target is $\geq$50\,Hz \\
...
\begin{itemize}
  ...
  \item If the UWB link to the user remote is lost for more than 5 seconds, the cart shall decelerate to a stop and revert to IDLE mode.
...
\begin{itemize}
  \item The physical remote provides three buttons: \textbf{Follow} (activate follow-me), \textbf{Stop} (emergency stop), and \textbf{Idle} (pause and hold position) --- no touchscreen, no app, no setup.
